#!/usr/bin/env node
/**
 * renderResume.js — Render a tailored_resume.json into HTML and PDF.
 *
 ...
 *
 * Usage:
 *   node scripts/renderResume.js <tailored_resume.json> [--output-dir <dir>]
...
function renderToHtml(resumeJson) {
    try {
 ...
 */
function renderBuiltInHtml(resume) {
...
async function main() {
    ...
    if (args.length === 0 || args.includes('--help')) {
        console.log('Usage: node scripts/renderResume.js <tailored_resume.json> [--output-dir <dir>]');
...
module.exports = { renderToHtml, renderToPdf, renderBuiltInHtml };
